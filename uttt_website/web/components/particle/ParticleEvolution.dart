...
class ParticleEvolutionElement {
  static ParticleEvolutionElement _evolutionElement;
  int _selectedGen;
  ParticleControlElement evolutionController;

  ParticleEvolutionElement._() {
    ...
    evolutionController = ParticleControlElement(control, _visualize);
  ...
  factory ParticleEvolutionElement() {
    if (_evolutionElement == null)
      _evolutionElement = ParticleEvolutionElement._();
    return _evolutionElement;
  }

  void setEra(ParticleEra era) {
  ...
  void _visualizeGeneration() {
    ...
    ParticleGeneration gen = evolutionController.era.generations[_selectedGen];
    List<DivElement> elements = gen.ratings.reversed
        .map((r) {
          Rating newr = Rating(r.particle);
          newr.stats = r.stats;
          return RatingElement(newr).element;
        })
