...
\begin{figure}[H]
	...
	\caption{Wasserfallmodell, \protect\citeA{wiki:Wasserfallmodellimage}}
\end{figure}
\subsubsection{Pro}
\begin{itemize}
...
\item Bei einer falschen Planung kann ein Projekt schnell ausarten. \citeA{wiki:Wasserfallmodell}
\end{itemize}
\subsection{IPERKA}
...
\begin{figure}[H]
	...
	\caption{IPERKA-Modell, \protect\citeA{web:iperkaimage}}
\end{figure}
\subsubsection{Pro}
\begin{itemize}
...
\subsubsection{Contra}
\begin{itemize}
\item Aufgaben können nicht parallel ausgeführt werden, Phasen können sich nicht überschneiden. \citeA{web:iperka}
\end{itemize}
\subsection{Scrum}
...
\begin{figure}[H]
	...
	\caption{Scrum-Modell, \protect\citeA{web:scrumimage}}
\end{figure}
\subsubsection{Pro}
\begin{itemize}
...
\begin{figure}[H]
	...
	\caption{V-Modell, \protect\citeA{wiki:vmodellimage}}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{ISO-Norm 9126, \protect\citeA{wiki:ISOimage}}
\end{figure}
...
Dieser Fall ist zwar Abacus-spezifisch, aber dennoch wichtig. Und zwar ist das ein Fehler der sehr viel Zeit kosten kann. Wird in einem Test ein \texttt{deleteAllRecords()} auf einer grossen Tabelle aufgerufen, braucht das enorm viel Zeit. Besser ist es, wenn man die benötigten Datensätze entweder dazu fügt oder einfach bearbeitet. Ein Warnzeichen für ein vergehen ist, wenn ein Test überraschend lange braucht. \citeA{web:abawikijunit5}
