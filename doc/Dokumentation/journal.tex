...
%evtl erklären, wieso wir die differen der beiden spieler nehmen
...
\begin{fixedpic}
	\centering
	\includegraphics[width=0.3\textwidth]{g1first}
	\includegraphics[width=0.3\textwidth]{g1middle}
	\includegraphics[width=0.3\textwidth]{g1last}
...
\addplot coordinates{(0, 108) (1, 379) (2, 856) (3, 1648) (4, 1745)};
\addplot coordinates{(0, 1408) (1, 1575) (2, 1801) (3, 205) (4, 1508)};
\addplot coordinates{(0, 1586) (1, 790) (2, 494) (3, 439) (4, 697)};
...
\begin{fixedpic}
	\centering
	\includegraphics[width=0.3\textwidth]{g5first}
	\includegraphics[width=0.3\textwidth]{g5middle}
	\includegraphics[width=0.3\textwidth]{g5last}
