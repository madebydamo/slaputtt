...
\begin{dayentry}{\DTMdisplaydate{2019}{1}{25}{-1}}
	\task{Moser}{Some changes in the documentation and finished section implementation in Dart. Wrote sections runtime, device, reflection of the work and challanges. Added list of acronyms.}
...
\begin{dayentry}{\DTMdisplaydate{2019}{1}{29}{-1}}
	...
	\task{Jampen}{Fixed some time cases in the implementaion of dart section.}
\end{dayentry}
